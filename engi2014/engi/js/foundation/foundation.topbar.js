      ...
      self.S('.has-dropdown>a', section).each(function () {
        ...
        if (!$dropdown.find('.title.back').length) {
          if (settings.mobile_show_parent_link && url && url.length > 1) {
            var $titleLi = $('<li class="title back js-generated"><h5><a href="javascript:void(0)"></a></h5></li><li><a class="parent-link js-generated" href="../../../js/foundation/' + url + '">' + $link.text() +'</a></li>');
          } else {
